...
public class KCUFExtTelephony extends IExtTelephony.Stub {
    ...
    private static KCUFExtTelephony sInstance;
    ...
    public static KCUFExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new KCUFExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private KCUFExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
